...
# 10 жизней
execute as @a[scores={uhk.deth=0}] run attribute @s minecraft:max_health base set 20

execute as @a[scores={uhk.deth=1}] run attribute @s minecraft:max_health base set 18

execute as @a[scores={uhk.deth=2}] run attribute @s minecraft:max_health base set 16

execute as @a[scores={uhk.deth=3}] run attribute @s minecraft:max_health base set 14

execute as @a[scores={uhk.deth=4}] run attribute @s minecraft:max_health base set 12

execute as @a[scores={uhk.deth=5}] run attribute @s minecraft:max_health base set 10

execute as @a[scores={uhk.deth=6}] run attribute @s minecraft:max_health base set 8

execute as @a[scores={uhk.deth=7}] run attribute @s minecraft:max_health base set 6

execute as @a[scores={uhk.deth=8}] run attribute @s minecraft:max_health base set 4

execute as @a[scores={uhk.deth=9}] run attribute @s minecraft:max_health base set 2
